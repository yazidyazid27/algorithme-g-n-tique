...
class CodageMantisse(Codage):
    
    def __init__(self,precisionMantisse,precisionExposant):
        # super().__init__()
    ...
    def code(self,nombres):
        ...
        for i in nombres:
            ...
            codage.append([self.remplissage_binaire(bin(nombre_entier),self.precisionMantisse),self.remplissage_binaire(bin(exposant),self.precisionExposant)])
...
if __name__ == '__main__':
    ...
    codageMantisse=CodageMantisse(32,6)
    ...
    eps=[-0.0099,0,0.000875448544,0.00036]
    feps=codageMantisse.code(eps)
